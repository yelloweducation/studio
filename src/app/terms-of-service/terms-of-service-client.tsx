...
const tosStaticTranslations = {
  en: {
    backToHome: "Back to Home",
    pageTitle: "Terms of Service",
    defaultContent: "<p>Our terms of service details will be available here soon. Please check back later or contact us for more information.</p>",
    loadingError: "Could not load terms of service content. Please try again later.",
  },
  my: {
    backToHome: "ပင်မသို့ ပြန်သွားရန်",
    pageTitle: "ဝန်ဆောင်မှုစည်းမျဉ်းများ",
    defaultContent: "<p>ကျွန်ုပ်တို့၏ ဝန်ဆောင်မှုစည်းမျဉ်းများ အသေးစိတ်ကို ဤနေရာတွင် မကြာမီ ရရှိနိုင်ပါမည်။ နောက်မှ ပြန်လည်စစ်ဆေးပါ သို့မဟုတ် နောက်ထပ်အချက်အလက်များအတွက် ကျွန်ုပ်တို့ထံ ဆက်သွယ်ပါ။</p>",
    loadingError: "ဝန်ဆောင်မှုစည်းမျဉ်းများ အကြောင်းအရာကို တင်၍မရပါ။ နောက်မှ ပြန်ကြိုးစားကြည့်ပါ။",
  }
};
...
export default function TermsOfServiceClient() {
  ...
  const t_static = tosStaticTranslations[language];
