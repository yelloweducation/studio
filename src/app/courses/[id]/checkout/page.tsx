...
const checkoutPageTranslations = {
  ...
  my: {
    ...
    purchaseCourseTitle: "သင်တန်းဝယ်ယူရန်: {title}",
    ...
    submitPaymentProof: "ငွေပေးချေမှု အထောက်အထား တင်သွင်းရန်",
    submitting: "တင်သွင်းနေသည်...",
    authenticationRequired: "အထောက်အထား လိုအပ်သည်",
    loginToProceed: "သင်တန်းဝယ်ယူမှုကို ဆက်လက်ဆောင်ရွက်ရန် ကျေးဇူးပြု၍ လော့ဂ်အင်ဝင်ပါ။",
    login: "လော့ဂ်အင်",
    courseNotFound: "သင်တန်း မတွေ့ပါ",
    courseNotFoundDesc: "သင်ဝယ်ယူရန်ကြိုးစားနေသော သင်တန်း (ID: {courseId}) ကို ရှာမတွေ့ပါ။",
    goToHomepage: "ပင်မစာမျက်နှာသို့ သွားရန်",
    freeCourse: "အခမဲ့ သင်တန်း",
    freeCourseDesc: "ဤသင်တန်းသည် အခမဲ့ရရှိနိုင်ပါသည်!",
    noPaymentRequired: "\"{title}\" အတွက် ငွေပေးချေရန် မလိုအပ်ပါ။ သင်ချက်ချင်း စတင်လေ့လာနိုင်ပါသည်။",
    goToCourse: "သင်တန်းသို့ သွားရန်",
    ...
    submissionErrorDesc: "အသုံးပြုသူ အထောက်အထားမရှိပါ သို့မဟုတ် သင်တန်း/စျေးနှုန်း အသေးစိတ်များ ပျောက်ဆုံးနေသည်။",
